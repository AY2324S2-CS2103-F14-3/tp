...
public class CommandTestUtil {
    ...
    public static final String VALID_NOTE_AMY = "hardworking";
    public static final String VALID_NOTE_BOB = "creative";
    ...
    public static final String NOTE_DESC_AMY = " " + PREFIX_ADDNOTE + VALID_NOTE_AMY;
    public static final String NOTE_DESC_BOB = " " + PREFIX_ADDNOTE + VALID_NOTE_BOB;
